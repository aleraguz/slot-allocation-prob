function [sol_greedy, colonna_slot_assegnati] = GreedyVera(arrayVoli, capacita_slot, num_slot,num_voli,intorno)
...
passeggeri_scalo(1:num_voli)=cell2mat(arrayVoli(2:num_voli+1,6));
passeggeri_voli_scalo = passeggeri_voli+passeggeri_scalo;
colonna_slot_assegnati = cell2mat(arrayVoli(2:(num_voli+1),5));
[pass_ordinati, ind]= OrdinaPasseggeri(passeggeri_voli_scalo);
